...
export default function CarCardCompact({ car }: CarCardCompactProps) {
  ...
  return (
    ...
    >
      {/* PARTE SUPERIOR: Imagen Completa - 260px exactos */}
      ...
      {/* PARTE INFERIOR: Información - 140px exactos (400 - 260 = 140) */}
      <div className="pl-5 pr-5 pt-2 pb-4 flex flex-col justify-between flex-shrink-0" style={{ height: '140px' }}>
        ...
        <div className="flex justify-between items-start relative" style={{ marginBottom: '4px' }}>
          ...
          <div className="text-right flex flex-col items-end">
            ...
            <div 
              className="bg-[#2b5ba9] text-white py-1 pl-5 pr-5 rounded-l-full flex items-baseline shadow-sm" 
        ...
        {/* Divisor Fino */}
        <hr className="border-gray-200" style={{ marginTop: '4px', marginBottom: '4px' }} />
