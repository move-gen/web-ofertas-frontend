    ...
    >
      {items.map((item, idx) => (
        <a
          href={item.link}
          key={item.id}
          className="relative group block p-2 w-full h-full flex"
...
export const Card = ({
  ...
  return (
    <div
      className={cn(
        "rounded-2xl h-full w-full p-4 overflow-hidden bg-white dark:bg-black border border-transparent dark:border-white/[0.2] relative z-20",
        className
      )}
    >
